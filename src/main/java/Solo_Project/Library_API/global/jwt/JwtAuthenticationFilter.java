package Solo_Project.Library_API.global.jwt;

import Solo_Project.Library_API.domain.member.entity.Member;
import Solo_Project.Library_API.global.LoginDto;
...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request,
        ...
        // 로그인 이후 response 헤더에 포함되는
        // Authorization이 전달이 되지 않음으로 인해
        // JwtAuthenticationFilter 클래스 내부에서
        // 인증에 성공할 때 JWT를 생성하여 응답 헤더로
        ...
        this.getSuccessHandler().onAuthenticationSuccess(request, response, authResult);  // 12번 클래스 추가.
    ...
    private String delegateAccessToken(Member member) {
        ...
        String accessToken
                = jwtTokenizer.generateAccessToken(claims,
                subject,
                expiration,
